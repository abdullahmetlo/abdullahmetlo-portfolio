    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div>
            ...
            <p className="mt-3 text-slate-600 dark:text-zinc-400 text-sm sm:text-base max-w-xl">
              Professional credentials validating technical acumen in Cloud Computing, Business Intelligence, Software Engineering, and Machine Learning.
            </p>
          </div>
        ...
        <div
          ...
          className={`flex gap-6 overflow-x-auto pb-6 pt-2 scrollbar-none ${
            isDragging
          ...
          {certifications.map((cert: Certification) => (
            ...
            >
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-zinc-900/90 mt-2">
                <div className="flex items-center gap-1.5 mb-2 text-[11px] font-mono text-slate-600 dark:text-zinc-400">
